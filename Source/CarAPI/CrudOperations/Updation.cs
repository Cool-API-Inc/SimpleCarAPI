            ...
            else
            {
                 ...
                 * მნიშვნელობას Query-ში, შესაბამის ბრძანებასთან ერთად */
                {
                    if (brand != null) // ვამოწმებთ მოწოდებულ ბრენდს
                    {
                        ...
                        else { return new UpdationResult(false, UpdationResult.ResultCode.INVALID_BRAND); }
                    }
                    if (year != null) // ვამოწმებთ მოწოდებულ გამოშვების წელს
                    {
                        ...
                        else { return new UpdationResult(false, UpdationResult.ResultCode.INVALID_YEAR); }
                    }
                    if (desc != null) // ვამოწმებთ მოწოდებულ აღწერას
                    {
                        ...
                        else { return new UpdationResult(false, UpdationResult.ResultCode.INVALID_DESCRIPTION); }
                    }
                    if (img != null) // ვამოწმებთ მოწოდებულ ფოტოს
                    {
                        ...
                        else { return new UpdationResult(false, UpdationResult.ResultCode.INVALID_IMAGE); }
                    }
                    if (features != null) // ვამოწმებთ მოწოდებულ მახასიათებლების ნამრავლს
                    {
                        ...
                        else { return new UpdationResult(false, UpdationResult.ResultCode.INVALID_FEATURES); }
                    }
